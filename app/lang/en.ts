const en = {
  ...
  priceSectionSubtitle: "Pricing",
  priceSectionTitle: 'Simple plans for <span class="font-serif italic font-medium tracking-[0.0264em] text-accent-blue">every stage </span> of your care. ',
  priceSectionDescription: "Start free. Upgrade whenever you need deeper case review, priority handling, or coordination across borders.",
