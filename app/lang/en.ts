const en = {
  ...
  plans: [
    {
      name: "Free",
      tagline: "Start organizing your care",
      price: "$0",
      cadence: "forever",
      features: [
    ...
    {
      name: "Personal",
      tagline: "Personal health coordination",
      price: "$7",
      cadence: "per month",
      features: [
        "100 AI chat questions per month",
        "Priority treatment request",
    ...
    {
      name: "Global Access",
      tagline: "Cross-border case coordination",
      price: "$18",
      cadence: "per month",
      features: [
        "350 AI chat questions per month",
        "Priority treatment request",
        "Medical document review",
        "Multi-country clinic matching",
      ],
      cta: "Contact us",
      href: "waitlist",
    }
  ],
  priceSectionSubtitle: "Adamiani Membership",
  priceSectionTitle: '<span class="font-serif italic font-medium tracking-[0.0264em] text-accent-blue">More than AI Chat </span> — healthcare coordination and case management in one place. ',
  priceSectionDescription: "Your membership includes healthcare coordination, medical case organization, document management, and AI assistance — all in one platform.",
  priceCancel: "Cancel any time · No hidden fees",
  ...
  fileLabel: "Attach medical documents (optional)",
  ...
  aiNots: "If you want images, scans or documents to be reviewed, please use the Treatment Request form below.",
  assistantTagline: "Organizes your case · AI assistant · not a doctor and does not replace medical advice",
  ...
  successMessage: "Thank you! You’ve successfully joined Adamiani Early Access.",
  ...
  chatPlaceholder: "Describe your symptoms or ask about treatment options..",
  sendButton: "Send",
