              ...
              {[
                ...
                <div key={title} className="flex gap-4 rounded-3xl bg-[#FAFAF7] p-4">
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-sm leading-6 text-[#5A6B7B]">
                      {text}
                    </p>
                  </div>
                </div>
  ...
  <div className="mx-auto grid max-w-6xl gap-10 lg:grid-cols-[0.95fr_1.05fr]">
    <div>
      <p className="mb-4 text-sm font-semibold tracking-[0.3em] text-[#B8893F]">
        {t.clinicTag.toUpperCase()}
      </p>
      <h2 className="text-4xl font-bold leading-tight text-[#1A3A5C] md:text-5xl">
        {t.clinicTitle}
      </h2>
      <p className="mt-6 text-lg leading-8 text-[#5A6B7B]">
        {t.clinicText}
      </p>
      ...
      <motion.button
        ...
        whileTap={{ scale: 0.97 }}
        onClick={() => scrollTo("waitlist")}
        className="mt-8 rounded-full bg-[#1A3A5C] px-8 py-4 font-semibold text-white transition hover:bg-[#15314E]"
      >
        {t.primaryCta}
      </motion.button>
    </div>
